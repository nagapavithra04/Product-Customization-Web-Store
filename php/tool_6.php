...
<div>
    ...
    <div id="custom-tshirt" class="container">
        <div class="image_container">
            <h1 class="name">CUSTOMIZED PILLOW-COVER</h1>
            <div id="tshirt-div">
                <div id="tshirt">
                <img src="../img/m3.png"  alt="..." width="400px" height="400px">
                    <div id="drawingArea" class="drawing-area" style="height: 310px;width: 300px;margin-left: -49px;margin-top: 38px;">
                        <div class="canvas-container">
                            <canvas id="tshirt-canvas" width="300" height="310"></canvas>
                        </div>
                    </div>
                </div>
            </div>          
        ...
        <div class="customs">
            ...
            <label for="tshirt-design">Pillow-Cover Design:</label>
