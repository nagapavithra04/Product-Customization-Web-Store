...
<div>
    ...
    <div id="custom-tshirt" class="container">
        <div class="image_container">
            ...
            <div id="tshirt-div">
                <div id="tshirt">
                <img src="../img/m5.png"  alt="..." width="400px" height="400px">
                    <div id="drawingArea" class="drawing-area" style="height: 250px;width: 170px;margin-left: 25px;margin-top: 90px;">
                        <div class="canvas-container">
                            <canvas id="tshirt-canvas" width="170" height="250"></canvas>
                        </div>
                    </div>
                </div>
            </div>          
