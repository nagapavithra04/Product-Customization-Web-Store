...
<div>
    ...
    <div class="container">
            <div class="image">
            <h1 style="margin-top: 20px;margin-left: -60px;font-size:40px;">Pillow</h1>
...
<table class="table1">
  ...
  <td>Hypoallergenic, Machine washable</td>
  </tr>
  <tr>
  <td>Net Quantity</td>
  <td>1 count</td>
...
<ul>
    <li>Stylish and comfortable pillow made from high-quality materials</li>
    <li>Soft and plush, providing excellent support for the back, neck, and arms</li>
    <li>Stylish design and color options to match any decor or personal style</li>
    <li>Removable cover made from durable and easy-to-clean materials for convenient maintenance</li>
    <li>Can also be used as a decorative accent on a bed or chair</li>
