...
<div>
    ...
    <div class="container">
            <div class="image">
            <h1 style="margin-top: 20px;margin-left: -60px;font-size:40px;">Cotton Towel</h1>
...
<table class="table1">
  ...
  <td>Quick-drying, Machine washable</td>
  </tr>
  <tr>
  <td>Net Quantity</td>
  <td>1 count</td>
...
<ul>
    <li>High-quality and absorbent towel made from premium materials</li>
    <li>Soft and gentle on the skin, making it suitable for all ages and skin types</li>
    <li>Fast-drying and highly absorbent, making it perfect for use at home, the gym, or on-the-go</li>
    <li>Durable and long-lasting, maintaining its quality even after multiple washes</li>
    <li>Machine washable for easy maintenance and convenience</li>
