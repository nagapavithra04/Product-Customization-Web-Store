...
<div>
    ...
    <div id="custom-tshirt" class="container">
        <div class="image_container">
            ...
            <div id="tshirt-div">
                <div id="tshirt">
                <img src="../img/m.png"  alt="..." width="400px" height="400px">
                    <div id="drawingArea" class="drawing-area" style="height: 350px;width: 240px;margin-left: 37px;margin-top: 15px;">
                        <div class="canvas-container">
                            <canvas id="tshirt-canvas" width="240" height="350"></canvas>
                        </div>
                    </div>
                </div>
            </div>          
