...
<div>
    ...
    <div class="container">
            <div class="image">
            <h1 style="margin-top: 20px;margin-left: -60px;font-size:40px;">Mug's For Presenting Gifts</h1>
            ...
            <div class="detail">
                <div class="product1">
                    ...
                    <table class="table1">
                      ...
                      <td>Microwave Safe, Dishwasher Safe</td>
                      </tr>
                      <tr>
                      <td>Net Quantity</td>
                      <td>1 count</td>
      ...
      <div class="description">
        ...
        <ul>
            <li>High quality printed ceremic mugs</li>
            <li>A mug is microwave safe and dishwasher safe.; Heavy build for long time use.</li>
            <li>Super White Ceramic, High-Quality Digital Printing And Premium Quality Gloss Finished</li>
            <li>Beautifully and professionally printed ceramic beverage mugs suitable to gift on any occasion to your loved ones.</li>
