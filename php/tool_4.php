...
<div>
    ...
    <div id="custom-tshirt" class="container">
        <div class="image_container">
            <h1 class="name">CUSTOMIZED CAP</h1>
            <div id="tshirt-div">
                <div id="tshirt">
                <img src="../img/m4.png"  alt="..." width="400px" height="400px">
                    <div id="drawingArea" class="drawing-area" style="height: 145px;width: 220px;margin-left: -16px;margin-top: 55px;">
                        <div class="canvas-container">
                            <canvas id="tshirt-canvas" width="220" height="145"></canvas>
                        </div>
                    </div>
                </div>
            </div>          
        ...
        <div class="customs">
            ...
            <label for="tshirt-design">Cap Design:</label>
