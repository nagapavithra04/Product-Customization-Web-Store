			...
			<form action="" id="manage-category">
				<div class="card">
					<div class="card-header">
						    Custom_Category Form
				  	</div>
					<div class="card-body">
							<input type="hidden" name="id">
							<div class="form-group">
								<label class="control-label">Custom_Category</label>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<?php 
									$i = 1;
									$cats = $conn->query("SELECT * FROM custom_built order by id asc");
...
<script>
	...
	$('#manage-category').submit(function(e){
		...
		start_load()
		$.ajax({
			url:'ajax.php?action=save_customs',
