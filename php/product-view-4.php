...
<div>
    ...
    <div class="container">
            <div class="image">
            <h1 style="margin-top: 20px;margin-left: -60px;font-size:40px;">Stylish Cap </h1>
...
<table class="table1">
  ...
  <td>Adjustable strap, Embroidered logo</td>
  </tr>
  <tr>
  <td>Net Quantity</td>
  <td>1 count</td>
...
<ul>
    <li>Stylish and comfortable cap made from high-quality materials</li>
    <li>Made with breathable fabric that helps keep your head cool and dry</li>
    <li>Adjustable strap at the back for a secure and comfortable fit</li>
    <li>Embroidered logo or design on the front adds a touch of personal style</li>
    <li>Suitable for outdoor activities such as sports, hiking, and camping, as well as casual wear</li>
    <li>Easy to clean and maintain, simply wipe with a damp cloth</li>
...
window.alert_toast= function($msg = 'TEST',$bg = 'success'){
  ...
  $('#add_to_cart_modal').click(function(){
		...
		$.ajax({
			...
			method:'POST',
			data:{pid:'<?php echo $_GET['id'] ?>',qty:$('[name="qty"]').val(),customize:0,size: 'Standard'},
			success:function(resp){
				if(resp == 1 )
