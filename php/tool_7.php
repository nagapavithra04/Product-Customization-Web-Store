...
<div>
    ...
    <div id="custom-tshirt" class="container">
        <div class="image_container">
            <h1 class="name">CUSTOMIZED TOWEL</h1>
            <div id="tshirt-div">
                <div id="tshirt">
                <img src="../img/m2.png"  alt="..." width="400px" height="400px">
                    <div id="drawingArea" class="drawing-area" style="height: 400px;width: 400px;margin-top: -10px;margin-left: -100px">
                        <div class="canvas-container">
                            <canvas id="tshirt-canvas" width="400px" height="400px"></canvas>
                        </div>
                    </div>
                </div>
            </div>          
        ...
        <div class="customs">
            ...
            <label for="tshirt-design">Towel Design:</label>
