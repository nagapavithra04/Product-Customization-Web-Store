...
<div>
    ...
    <div class="container">
            <div class="image">
            <h1 style="margin-top: 20px;margin-left: -60px;font-size:40px;">Bluelight's Custom T-Shirt </h1>
            <img src="<?php echo $qry1['img_path']?>"  alt="<?php echo $qry1['img_path']?>" width="470px" height="470px"style="margin-top: 30px;margin-left: -50px;" >
...
window.alert_toast= function($msg = 'TEST',$bg = 'success'){
  ...
  $('#add_to_cart_modal').click(function(){
		...
		$.ajax({
			...
			method:'POST',
			data:{pid:'<?php echo $_GET['id'] ?>',qty:$('[name="qty"]').val(),customize:1,size:$('[name="size"]').val()},
			success:function(resp){
				if(resp == 1 )
